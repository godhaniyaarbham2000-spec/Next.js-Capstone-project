    ...
    <div className="min-h-screen flex">
      <aside className="w-64 border-r bg-gray-50 p-4 flex flex-col gap-4">
        ...
        <nav className="flex flex-col gap-2">
          <Link href="/projects" className="p-2 hover:bg-gray-200 rounded">Projects</Link>
          {session.user.role === "ADMIN" && <Link href="/admin" className="p-2 hover:bg-gray-200 rounded">Admin</Link>}
        </nav>
      </aside>
